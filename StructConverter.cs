...
namespace Nus3Audio_Editor
{
    ...
    public class StructConverter
    {
        ...
        public static object[] Unpack(string fmt, ref int skipCount, byte[] bytes)
        {
            ...
            bytes = bytes.Skip(skipCount).Take(totalByteLength).ToArray();
            skipCount += 4;
        ...
        public static object[] Unpack(string fmt, int skipCount, byte[] bytes)
        {
            int dummy = skipCount;
            return Unpack(fmt, ref dummy, bytes);
        }
